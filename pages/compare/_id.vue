...
export default {
  ...
  head: () => ({
    ...
    meta: [
      ...
      { name: 'og:url', content: 'https://hypatie.africitizen.co' },
      { name: 'og:image', content: 'https://hypatie.africitizen.co/icon.png' },
      // Twitter Card
      ...
      { name: 'twitter:image', content: 'https://hypatie.africitizen.co/icon.png' },
